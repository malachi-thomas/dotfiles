...
sidebarResizeBar === null || sidebarResizeBar === void 0 ? void 0 : sidebarResizeBar.addEventListener("mousedown", (e) => {
    //if (e.button === 0) {
    //  isMouseDown = true
    //}
    console.log(isMouseDown);
});
sidebarResizeBar === null || sidebarResizeBar === void 0 ? void 0 : sidebarResizeBar.addEventListener("mousemove", (e) => {
    console.log(e);
});
